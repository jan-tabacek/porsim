...
product_mtp <- list(
  ...
  min_amount = 10,
  max_amount = 1000,
  contract_duration = 1+6, # one for contract creation + number of payments
...
segment_standard <- list(
  segment_name = "standard_payer", # Add a name for the segment
  avg_limit_pct_of_max = 0.80,
  avg_first_balance_pct_of_limit = 0.95,
  default_prob = c(0.05, 0.02, 0.01, 0.01, 0.005),
...
# portfolio_metrics <- calculate_portfolio_metrics(portfolio_history)
